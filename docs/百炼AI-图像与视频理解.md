...
-   **首选 Qwen3.6**：最新一代视觉理解模型，相比Qwen3.5-Plus，在代码开发、泛化推理、多模态能力（万物识别、OCR、物体定位）等方面显著增强。
...
| --- | --- | --- | --- | --- | --- |
| `Qwen3.6`系列、`Qwen3.5`系列 | 支持  | 支持  | `qwen3.6-plus`、`qwen3.5-plus`、`qwen3.5-flash` > 仅支持显式缓存 | 非思考模式支持 | 33种；分别为中文、日语、韩语、印尼语、越南语、泰语、英语、法语、德语、俄语、葡萄牙语、西班牙语、意大利语、瑞典语、丹麦语、捷克语、挪威语、荷兰语、芬兰语、土耳其语、波兰语、斯瓦希里语、罗马尼亚语、塞尔维亚语、希腊语、哈萨克语、乌兹别克语、宿务语、阿拉伯语、乌尔都语、波斯语、印地语 / 天城语、希伯来语。 |
