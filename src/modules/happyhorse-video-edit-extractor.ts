/**
 * 快乐马视频编辑响应提取器
 * 适用 callMode: happyhorse-video-edit-bailian
 *
 * 响应格式与参考生视频完全相同（阿里云百炼 DashScope）：
 ...
 *
 * 注意：此 extractor 与 happyhorse-video-extractor.ts 完全独立，
 * 即使响应格式相同，也保持代码隔离，便于未来差异化处理。
 */
 ...
 * 快乐马视频编辑响应提取器
 */
export const happyHorseVideoEditExtractor: VideoResponseExtractor = {
