/**
 * Grok 视频响应提取器（才翔AI）
 * 适用 callMode: grok-video-caixiang
 *
 * 响应格式（才翔AI API）：
 * - 创建: { code: 200, data: { task_id: 123456, ... }, msg: "..." }
 ...
 * Grok 视频响应提取器（才翔AI）
 */
export const grokVideoCaixiangExtractor: VideoResponseExtractor = {
