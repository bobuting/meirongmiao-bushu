/**
 * image-callmodes/seedream-image.ts
 *
 * CallMode: SEEDREAM_IMAGE_ARK
 * 协议: 火山方舟 Seedream /api/v3/images/generations（OpenAI 兼容）
 */
...
export const seedreamImageHandler: ImageCallModeHandler = {
  buildRequest,
  extractImageUrls,
};
